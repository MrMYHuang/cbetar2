# <a id='history'>版本歷史</a>
* PWA 10.10.4:
  * [更新] 更新全字庫楷書字型 (CNS11643 2024-08-15 版)。
...
* PWA 10.10.2:
  * [修正] 更新至 epubjs-myh 0.3.125，解決行距在 iOS Safari 無作用的問題。

* PWA 10.10.1:
  * [修正] 同時多次點擊儲存一部經的書籤，可能會造成卷內容順序異常。
...
* PWA 10.9.2:
  * [修正] iOS Safari 16.4 顯示直排分頁模式排版異常。
  * [修正] iOS Safari 經文頁雙擊浮動按鈕會放大的問題。
