...
export default function reducer(state = {
  ...
  switch (action.type) {
    ...
    default:
      ...
      var keys = ['topCatalogsType', 'paginated', 'rtlVerticalLayout', 'scrollbarSize', 'useFontKai', 'fontSize', 'uiFontSize', 'darkMode', 'showComments', 'speechRate', 'bookmarks'];
      var vals = [0, 1, 1, 2, 1, 32, 24, 1, 0, 0.8, []];
